...
export default function TimeSeriesChart({
    ...
    return (
        <div className="h-full min-h-[300px] w-full">
            {title && <h3 className="text-lg font-semibold mb-4 text-center text-neutral-300">{title}</h3>}{" "}
            {/* Updated text */}
            <ResponsiveContainer width="100%" height={300}>
                ...
                >
                    ...
                    <YAxis
                        ...
                        label={
                            yAxisLabel
                                ? { value: yAxisLabel, angle: -90, position: "insideLeft", fill: "#737373", dy: -10 }
                                : undefined
                        } // neutral-500 label
                        domain={["auto", "auto"]}
                    ...
                    <Tooltip
                        ...
                        formatter={(value: number, name: string) => [
                            `${formatValueTick(value)} ${name === "count" ? "items" : ""}`,
                            name,
                        ]}

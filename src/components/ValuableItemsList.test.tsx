...
describe('ValuableItemsList Component', () => {
  ...
  const mockItems = [
    { id: 1, release_id: 101, artist: 'Artist A', title: 'Album 1', cover_image_url: 'img1.jpg', condition: 'NM', suggested_value: 25.50 },
    { id: 2, release_id: 102, artist: 'Artist B', title: 'Album 2', cover_image_url: 'img2.jpg', condition: 'VG+', suggested_value: 10.00 },
    { id: 3, release_id: 103, artist: null, title: null, cover_image_url: null, condition: null, suggested_value: null }, // Item with missing data
  ];
